    ...
    >
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="min-w-0">
          <h2 className="font-heading text-xl sm:text-2xl font-black text-foreground tracking-tight leading-snug break-words">
            {event.title}
          </h2>
        </div>
        ...
        <div className="bg-muted/40 border border-border/70 rounded-xl p-3 flex items-center justify-between gap-3">
          ...
          <div className="text-right shrink-0 min-w-0 max-w-[42%]">
            ...
            <span className="inline-block max-w-full truncate align-bottom bg-card border border-border text-foreground font-bold text-xs px-2.5 py-1 rounded-md mt-0.5">
